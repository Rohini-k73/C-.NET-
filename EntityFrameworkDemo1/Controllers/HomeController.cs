...
namespace EntityFrameworkDemo1.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Sid,Sname,Spercentage,Slocation")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Sid,Sname,Spercentage,Slocation")] Student student)
        {
            if (id != student.Sid)
            {
                return NotFound();
